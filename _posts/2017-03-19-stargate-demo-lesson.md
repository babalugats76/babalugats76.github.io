...
{% include video.html %}
<p>Click on the link below, then &ldquo;Remix&rdquo; in the upper right-hand corner, to begin your own Innovation web page.</p>
...
<h3>Padlet</h3>
<p>Double-click anywhere on the Padlet below to add the link to your Innovation web page.  Remember to title your post using only the <span class="highlighter">first name and last initial</span> of each author!</p>
