...
<h3>Padlet</h3>
<p>Double-click anywhere on the Padlet to add the link to your Innovation web page.  Remember to title your post using only the <span class="highlighter">first name and last initial</span> of each author!</p>
